...
public class ContainerNameGenerator {
   ...
   * @param machineId unique machine id
   * @param userName name of the user who is docker container owner
   * @param machineName name of the workspace machine
   */
  public String generateContainerName(
      String workspaceId, String machineId, String userName, String machineName) {
